			...
			<form class="form-horizontal" role="form" method="post" id="login-form">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						...
						<a id="reset-link" href="{config.relative_path}/reset" class="collapse-modal text-link">[[login:forgot_password]]</a>
				...
				<div class="form-group">
					<div class="col-lg-8">
						...
						<span class="help-block" style="text-align: center;">[[login:dont_have_account]] <a href="#" class="show-register text-link">[[register:register]]</a></span>						
					</div>
				</div>
			</form>
